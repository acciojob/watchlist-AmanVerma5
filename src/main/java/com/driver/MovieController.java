...
public class MovieController {
    ...
    public ResponseEntity<String> addMovieDirectorPair(@RequestParam String name,@RequestParam String director){
        movieService.createMovieDirectorPair(name,director);
